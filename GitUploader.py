...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "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", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "maksin275", lambda m: self.strings("cfg_gh_user", m),
            "GH_REPO", "Modyl", lambda m: self.strings("cfg_gh_repo", m))
